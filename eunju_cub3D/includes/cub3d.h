...
void					rotate_player(t_player *player, double	rot_spee, int keycode);
void					move_player_forward(t_player *player, t_cub *cub, double move_peed);
void					move_player_left(t_player *player, t_cub *cub, double move_peed);
void					move_player_backward(t_player *player, t_cub *cub, double move_peed);
void					move_player_right(t_player *player, t_cub *cub, double move_peed);
