...
/*   Updated: 2021/04/01 15:18:56 by ukim             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				norm_ba(t_info *all, int *arr, t_list **ta, t_list **tb);
void				norm_bb(t_info *all, int *arr, t_list **ta, t_list **tb);
void				norm_ba_at(t_info *all, int *arr, t_list **ta, t_list **tb);
void				norm_bb_at(t_info *all, int *arr, t_list **ta, t_list **tb);
